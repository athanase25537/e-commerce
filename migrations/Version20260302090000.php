...
final class Version20260302090000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $hasCustomerOrder = $schemaManager->tablesExist(['customer_order']);
