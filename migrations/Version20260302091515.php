...
final class Version20260302091515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_order ADD COLUMN subtotal INTEGER NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE customer_order ADD COLUMN shipping_method VARCHAR(30) NOT NULL DEFAULT \'standard\'');
        $this->addSql('ALTER TABLE customer_order ADD COLUMN shipping_fee INTEGER NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE customer_order ADD COLUMN discount_amount INTEGER NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE customer_order ADD COLUMN payment_method VARCHAR(30) NOT NULL DEFAULT \'card\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer_order (id SERIAL PRIMARY KEY, customer_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(30) DEFAULT NULL, address_line1 VARCHAR(255) NOT NULL, address_line2 VARCHAR(255) DEFAULT NULL, city VARCHAR(100) NOT NULL, postal_code VARCHAR(30) DEFAULT NULL, country VARCHAR(80) NOT NULL, status VARCHAR(30) NOT NULL, total_amount INTEGER NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, user_id INTEGER DEFAULT NULL, CONSTRAINT FK_3B1CE6A3A76ED395 FOREIGN KEY (user_id) REFERENCES app_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
